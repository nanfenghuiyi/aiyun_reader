  ...
  <div class="container" v-loading="loading">
    ...
    <div class="section-genealogy">
      <van-popup v-model="genealogyShow" position="left" :style="{ with: '100%', height: '100%'}">
        ...
        <!-- 搜索结果显示 -->
        <div v-show="searchShow" class="res-show">
...
export default {
  ...
  methods: {
    ...
    loadMore(e) {
      ...
      // 测试
      var obj={page: page, page_size: 3, depth: this.depth, user_id: this.user_id, token: 'P62_K_Vve325khpTB/QX0Q=='} 
      
      // var obj={page: page, page_size: 3, depth: this.depth, token: this.token}
      console.log(obj)
    ...
    menuGetGenealogy() {
      ...
      // 测试
      var obj = {token:'P62_K_Vve325khpTB/QX0Q=='};
    ...
    onSearch(page) {
      ...
      if (this.searchValue != '') {
        ...
        // 测试
        var obj = {keyword:this.searchValue, page:page, page_size: 20, token:'P62_K_Vve325khpTB/QX0Q=='};
  ...
  mounted() {
    // 获取当前窗口的高度
    console.log('获取当前窗口的高度==',$(window).height())
    console.log('获取当前窗口的80%高度==',$(window).height()*0.8)
